...
import com.devbridge.bookstore.domain.Author;
import com.devbridge.bookstore.repository.AuthorRepository;
...
public class AuthorResource {
    ...
    @Timed
    public ResponseEntity<Author> create(@Valid @RequestBody Author author) throws URISyntaxException {
    ...
    @RequestMapping(value = "/authors",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Author> update(@Valid @RequestBody Author author) throws URISyntaxException {
